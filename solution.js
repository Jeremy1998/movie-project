...
****************************************************/
var movieQueue=["Scarface","Warriors"];
...
****************************************************/
function addMovieToEnd(paidandfull){
  movieQueue.push(paidandfull)
  return paidandfull;
}
...
- Finally it should return the movie name it just added
****************************************************/
function changeMovie(index,getrichordietrying){
  movieQueue[index]=getrichordietrying
  return getrichordietrying;
}
